...
namespace CLUB.Areas.Employee.Controllers
{
    ...
    public class InfoViewController : Controller
    {
        ...
        public InfoViewController(IHostingEnvironment hostingEnvironment, ITraningHistoryService traningHistoryService, IServiceHistoryService serviceHistoryService, IPersonalInfoService personalInfoService, IAwardPublicationLanguageService awardPublicationLanguageService, IEmployeeInfoService employeeInfoService, IDrivingLicenseService drivingLicenseService, IMembershipService membershipService, IPassportInfoService passportInfoService, ISpouseChildrenService spouseChildrenService, IPhotographService photographService, IConverter converter)
        {
        ...
        public async Task<IActionResult> Index(int id)
        {
            ...
            {
                religion = new Data.Entity.Master.Religion(),
                employeeType = new Data.Entity.Master.EmployeeType()
            };

            if (model.addressPermanent == null) model.addressPermanent = new Data.Entity.Employee.Address
            {
                division = new Data.Entity.Master.Division(),
                district = new Data.Entity.Master.District(),
                thana = new Data.Entity.Master.Thana(),
                country = new Data.Entity.Master.Country()
            };

            if (model.addressPresent == null) model.addressPresent = new Data.Entity.Employee.Address
            {
                division = new Data.Entity.Master.Division(),
                district = new Data.Entity.Master.District(),
                thana = new Data.Entity.Master.Thana(),
        ...
        {
            string fileName;
            string status = myPDF.GeneratePDF(out fileName, $"Employee/InfoView/PrintView/{id}");
