...
namespace CLUB.Areas.Employee.Controllers
{
    ...
    public class AddressController : Controller
    {
        ...
        public AddressController(IHostingEnvironment hostingEnvironment, IPersonalInfoService personalInfoService, IEmployeeInfoService employeeInfoService)
        {
        ...
        public async Task<IActionResult> Index(int id)
        {
            ...
            if (model.permanent == null) model.permanent = new Data.Entity.Employee.Address();
            if (model.present == null) model.present = new Data.Entity.Employee.Address();
        ...
        public async Task<IActionResult> Index([FromForm] AddressViewModel model)
        {
            ...
            Data.Entity.Employee.Address presentdata = new Data.Entity.Employee.Address
            {
            ...
            Data.Entity.Employee.Address permanentdata = new Data.Entity.Employee.Address
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> IndexBigForm([FromForm] AddressViewModel model)
        {
            //if (!ModelState.IsValid)
            //{
            //    ViewBag.employeeID = model.employeeID;
